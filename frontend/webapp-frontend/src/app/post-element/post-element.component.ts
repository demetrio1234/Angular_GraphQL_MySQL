...
export class PostElementComponent implements OnInit {
  ...
  messageFromPostElement: string = 
      'I\'m a post-element article!';
  ...
  clickEventFromButtonOfPostElementComponent() {
    console.log(
        'Output on click from post element component works!'
        );
    this.outputEventEmitter
        .emit(this.emittedMessageFromPostElementComponent);
  }
}
