...
export class NavbarComponent {
  ...
  textAreaContentTemp: string = '';
  twoWayBindingVariable: string = '';

  onKeyUp($event: KeyboardEvent) {
    if ($event.code == 'Enter') {
      console.log('onKeyUp($event: KeyboardEvent) works');
      console.log(this.twoWayBindingVariable);
    }
  }

  onKeyUpWithoutParameters() {
    console.log(this.twoWayBindingVariable);
  }
  ...
  keyUp() {
    ...
    if (this.textAreaContent.length > 1
      && this.textAreaContent.trim() != this.textAreaContentTemp.trim()) {
      console.log(this.textAreaContent);

      this.textAreaContentTemp = this.textAreaContent;
